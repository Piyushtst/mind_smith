...
import 'package:mind_smith/controller/call_detail_controller.dart';
...
class CallDetailScreen extends GetWidget<CallDetailController> {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<CallDetailController>(
      init: CallDetailController(),
      builder: (controller) {
        return Scaffold(
          appBar: AppBar(
            elevation: 0.5,
              ...
              child: Column(
                children: [
                          ...
                          Container(
                            ...
                            child: Padding(
                              ...
                              child: Row(
                                children: [
                                  Image(
                                    image:  AssetImage(AppImage.whatsapp),
                    ...
                    child: Padding(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        AppButton(
                            ...
                            onTap: () {
                              Get.to(() => const AssessmentScreen());//Navigator.push(context, MaterialPageRoute(builder: (context) => const AssessmentScreen()));
                            }),
                        Space.height(16),
                      ]),
                    ),
                  ...
                  Stack(children: [
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              AppButton(
                                  ...
                                  bgColor: primaryColor,
                                  onTap: () {
                                    Get.to(() => const CartScreen());//Navigator.push(context, MaterialPageRoute(builder: (context) => const CartScreen()));
                                  }),
                              Container(
                                alignment: Alignment.center,
                                width: double.infinity,
                    ...
                    Container(
                      margin: EdgeInsets.only(top: MySize.getScaledSizeHeight(300.00)),
                      height: MySize.size32,
                      width: double.infinity,
                      decoration:  BoxDecoration(
                        image: DecorationImage(
                            image: AssetImage(AppImage.bottomBorder),
                            fit: BoxFit.fill),
                      ),
                    ),
                  ]),
