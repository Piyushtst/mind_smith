...
import 'package:mind_smith/controller/selected_address_controller.dart';
...
class SelectAddress extends GetWidget<SelectedAddressController> {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<SelectedAddressController>(
      init: SelectedAddressController(),
      builder: (controller) {
        return Scaffold(
          appBar: AppBar(
            elevation: 0.5,
            ...
            child: Column(
              children: [
                            ...
                            return Obx(() => InkWell(
                              ...
                              child: Container(
                                ...
                                decoration: BoxDecoration(
                                  color: primaryWhite,
                                  border: Border.all(color: controller.indx==index?greenShade:textFieldBorderColor),
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                      crossAxisAlignment: CrossAxisAlignment.start,
                                      children: [
                                        controller.indx==index
                                            ? Image(
                                          image:  AssetImage(AppImage.greenRound),
                                          fit: BoxFit.fill,
                                          height: MySize.size26,
                                          width: MySize.size26,
                                        )
                                            : Image(
                                          image:  AssetImage(AppImage.roundSelect),
                                          fit: BoxFit.fill,
                                          height: MySize.size26,
                                          width: MySize.size26,
                                        ),
                ...
                AppButton(
                    ...
                    onTap: () {
                      Get.to(() => const PaymentScreen());//Navigator.push(context, MaterialPageRoute(builder: (context) => const PaymentScreen()));
                    }),
                Space.height(24),
              ],
            ),
