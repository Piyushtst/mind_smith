...
import 'package:mind_smith/controller/cart_controller.dart';
            ...
            child: Column(
              children: [
                ...
                AppButton(
                    ...
                    onTap: () {
                      Get.to(() => const SelectAddress());//Navigator.push(context, MaterialPageRoute(builder: (context) => const SelectAddress()));
                    }),
                Space.height(24),
              ],
            ),
