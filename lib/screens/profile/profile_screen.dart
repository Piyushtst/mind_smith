              ...
              child: Column(
                children: [
                  ...
                  Row(
                    children: [
                      Image(
                        image:  AssetImage(AppImage.profilescreen),
                        fit: BoxFit.fill,
                        height: MySize.size90,
                        width: MySize.size90,
                      ),
                  ...
                  AppButton2(
                      ...
                      bgColor: primaryWhite,
                      onTap: () {
                        Get.to(() => const EditProfile());// Navigator.push(context, MaterialPageRoute(builder: (context) => const EditProfile()));
                      }),
                  Space.height(32),
                  Container(
                    alignment: Alignment.centerLeft,
                        ...
                        children: [
                          Row(
                            ...
                            children: [
                              ...
                              InkWell(
                                onTap: () {
                                  Get.to(() => const StarWalletScreen()); //Navigator.push(context, MaterialPageRoute(builder: (context) => const StarWalletScreen()));
                  ...
                  ListTile(
                    minLeadingWidth : MySize.size16,
                    leading: Image(
                      image:  AssetImage(AppImage.address),
                      height: MySize.size36,
                      width: MySize.size36,
                    ),
                    title: AppText1(
                  ...
                  ListTile(
                    minLeadingWidth : MySize.size16,
                    leading: Image(
                      image:  AssetImage(AppImage.roundNote),
                      height: MySize.size36,
                      width: MySize.size36,
                    ),
                    title: AppText1(
                  ...
                  Row(
                    ...
                    children: [
                      Image(
                        image:  AssetImage(AppImage.logOut),
                        height: MySize.size20,
                        width: MySize.size20,
                      ),
                      SizedBox(width: MySize.size10),
