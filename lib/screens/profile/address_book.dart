...
import 'package:mind_smith/controller/address_book_controller.dart';
...
class AddressBook extends GetWidget<AddressBookController> {
  const AddressBook({Key? key}) : super(key: key);
            ...
            child: Column(
              children: [
                ...
                AppButton2(
                    ...
                    bgColor: primaryWhite,
                    onTap: () {
                      Get.to(() => const AddAddress());//Navigator.push(context, MaterialPageRoute(builder: (context) => const AddAddress()));
                    }),
                Space.height(24),
              ],
            ),
