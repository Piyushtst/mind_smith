...
import 'package:mind_smith/controller/edit_profile_controller.dart';
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        height: MySize.size90,
                        width: MySize.size90,
                        decoration: controller.profileImage != null
                            ? BoxDecoration(
                          shape: BoxShape.circle,
                          image: DecorationImage(image: FileImage(controller.profileImage!), fit: BoxFit.cover),
                        )
                            : const BoxDecoration(
                          shape: BoxShape.circle,
                          image: DecorationImage(image: AssetImage("assets/images/png/profilescreen.png"), fit: BoxFit.cover),
