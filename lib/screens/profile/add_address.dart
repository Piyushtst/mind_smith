...
import 'package:mind_smith/controller/add_address_controller.dart';
...
class AddAddress extends GetWidget<AddAddressController> {
  const AddAddress({Key? key}) : super(key: key);
            ...
            child: Column(
              children: [
                ...
                AppButton(
                    ...
                    bgColor: primaryColor,
                    onTap: () {
                      Get.to(() => const MyOrderScreen());//Navigator.push(context, MaterialPageRoute(builder: (context) => const MyOrderScreen()));
                    }),
                Space.height(24),
              ],
            ),
