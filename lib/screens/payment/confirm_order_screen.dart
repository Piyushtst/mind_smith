...
import 'package:mind_smith/controller/confirmed_order_controller.dart';
...
class ConfirmedOrderScreen extends GetWidget<ConfirmedOrderController> {
  const ConfirmedOrderScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<ConfirmedOrderController>(
      init: ConfirmedOrderController(),
      builder: (controller) {
        return SafeArea(
          child: Scaffold(
            backgroundColor: bgWhite,
