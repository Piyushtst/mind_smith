...
import 'package:mind_smith/controller/filter_or_sort_controller.dart';
...
class FilterOrShortScreen extends GetWidget<FilterOrSortController> {
   FilterOrShortScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<FilterOrSortController>(
      init: FilterOrSortController(),
      builder: (controller) {
        return Scaffold(
          appBar: AppBar(
            elevation: 0.5,
                                    ...
                                    children: [
                                      Row(
                                        ...
                                        children: [
                                          ...
                                          Obx(() => InkWell(
                                            onTap: () {
                                              controller.inx.value = index;
                                              //setState(() {});
                                            },
                                            child: controller.inx.value == index
                                                ? Icon(
                                              Icons.favorite,
                                              color: Colors.red,
                                              size: MySize.size30,
                    ...
                    children: [
                      InkWell(
                        ...
                        child: Row(
                          children: [
                            Image(
                              image:  AssetImage(AppImage.filter),
                      ...
                      InkWell(
                        ...
                        child: Row(
                          children: [
                            Image(
                              image:  AssetImage(AppImage.sort),
                              height: MySize.size16,
                              width: MySize.size16,
                            ),
                            AppText1(
